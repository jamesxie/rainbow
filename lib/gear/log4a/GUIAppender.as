package gear.log4a {
	 ...
	 * @version 20110923
	 */
	public class GUIAppender extends GTitleWindow implements IAppender {
		...
		private function initData() : void {
			_data.modal = true;
			_data.titleBarData.bgSkin =GUIUtil.getSkin("GTitleBar_bgSkin","ui");
			_data.panelData.bgSkin = GUIUtil.getSkin(SkinStyle.panel_bgSkin);
			_data.width = 800;
			_data.height = 500;
		...
		private function createTextArea() : void {
			...
			data.textFieldFilters = GUIUtil.getEdgeFilters(0x000000, 0.5);
			data.editable = false;
		...
		private function createTextInput() : void {
			...
			data.textFieldFilters = GUIUtil.getEdgeFilters(0x000000, 1);
			data.maxChars = 100;
		...
		public function GUIAppender(parent : Sprite) {
