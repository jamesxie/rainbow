package gear.ui.manager {
	...
	public class GUIUtil {
		...
		//ASSkin.AS_LIB
		//public static function getSkin(key : String, lib : String = ASSkin.AS_LIB) : DisplayObject {
		public static function getSkin(key : String, lib : String = "asLib") : DisplayObject {
		...
		public static function getInputTextField() : TextField {
			var textField : TextField = new TextField();
			textField.defaultTextFormat = GUIUtil.getTextFormat();
			textField.text = "?";
			textField.height = textField.textHeight + 4;
			textField.text = "";
