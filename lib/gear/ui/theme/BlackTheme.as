package gear.ui.theme {
	...
	public class BlackTheme implements ITheme {
		...
		public function get GPanel_bgSkin() : Sprite {
			var skin : Sprite = new Sprite();
			var g : Graphics = skin.graphics;
		...
		public function get GTextArea_bgSkin() : Sprite {
			var skin : Sprite = new Sprite();
			var g : Graphics = skin.graphics;
			GDrawUtil.drawFillBorder(g, 0x000000, 0.7, 0, 0, 20, 20);
			GDrawUtil.drawRect(g, 0x000000, 0.2, 1, 1, 18, 18);
			GDrawUtil.drawFillBorder(g, 0x000000, 0.08, 1, 1, 18, 18);
			skin.scale9Grid = new Rectangle(2, 2, 16, 16);
			return skin;
		}

		public function get GTitleBar_bgSkin() : Sprite {
			// TODO redraw
			var skin : Sprite = new Sprite();
			var g : Graphics = skin.graphics;
			GDrawUtil.drawRect(g, 0x000000, 0.7, 0, 0, 20, 20);
		...
		public function get GTextInput_borderSkin() : Sprite {
			// TODO redraw
			var skin : Sprite = new Sprite();
			var g : Graphics = skin.graphics;
			GDrawUtil.drawFillBorder(g, 0x000000, 0.7, 0, 0, 20, 20);
