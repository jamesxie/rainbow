package gear.ui.data {
	...
	public class GSelectorData extends GBaseData {
		...
		public function GSelectorData() {
			...
			prev_buttonData.labelData.iconData.bitmapData = GLoadUtil.getBD("GSelector_prevIcon", "ui");
			prev_buttonData.width = 19;
			prev_buttonData.height = 19;
			next_buttonData = new GButtonData();
			next_buttonData.labelData.iconData.bitmapData = GLoadUtil.getBD("GSelector_nextIcon", "ui");
