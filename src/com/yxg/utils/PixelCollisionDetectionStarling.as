package com.yxg.utils
{
     ...
     */
	public class PixelCollisionDetectionStarling
	{
		...
		private static function getAlphaMap(target:DisplayObject, rect:Rectangle, channel:uint, commonParent:DisplayObjectContainer):BitmapData
		{
			...
			var parentXformInvert:Matrix = commonParent.transformationMatrix.clone();
			parentXformInvert.invert();
			var targetXform:Matrix = target.transformationMatrix.clone();
			...
			bitmapData.draw(target.bitmapDataTexture, targetXform);
